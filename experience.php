...
<main class="min-h-min">
    <div class="container grid grid-cols-1 sm:grid-cols-2 mx-auto px-16 lg:px-28 py-20 sm:py-44 items-center">
        ...
        <div class="col relative ">
            <div class="bg-black dark:bg-white absolute -translate-x-1 translate-y-10 min-[391px]:translate-y-6 min-[637px]:translate-y-10 min-[768px]:translate-y-6 rounded-full w-2 h-2">
            </div>
            <p class="px-4 sm:px-8 translate-y-2.5 text-lg">Décembre 2022 - Janvier 2023</p>
